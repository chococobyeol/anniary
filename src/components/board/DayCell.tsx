...
export const DayCell = memo(function DayCell({ vm, x, y, zoomLevel, isSelected, onClick }: Props) {
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        height={h}
        rx={1}
        fill={vm.isToday ? 'var(--bg-cell-today)' : 'var(--bg-cell)'}
      ...
      <text
        ...
        fill={vm.isToday ? 'var(--status-in-progress)' : 'var(--text-primary)'}
